	...
	<!-- SIGN IN -->
		<?php if(isset($_SESSION['logerr'])){ echo "<div id=\"signinform\" style=\"display: block \">";
		}else{echo "<div id=\"signinform\" style=\"display: none \">";}?>
		<!--div id="signinform" style="display: none"-->
			...
			<?php if(isset($_SESSION['logerr'])){ echo "Username and Password does not match";
			unset($_SESSION['logerr']);} ?>
			</form>
		</div>
	
	<!-- REGISTER -->
		<?php if(isset($_SESSION['regerr'])){ echo "<div id=\"regform\" style=\"display: block \">";
		}else{echo "<div id=\"regform\" style=\"display: none \">";}?>
		...
		<div id="listofservices">
               <?php
					...
					}else echo "<div class='bodytext1'>No services available</div>";
                    echo "</table>";
		...
		<!-- ROOM STATUS -->
			<?php if(isset($_SESSION['all'])||isset($_SESSION['viewvacant'])||isset($_SESSION['viewreserved'])){ echo "<div id=\"rmstatForm\" style=\"display: block \">";
		}else{echo "<div id=\"rmstatForm\" style=\"display: none \">";}?> 
	...
	<!-- CHECK OUT-->
			<center>
				...
				<?php 
						if(isset($_GET['error'])){
						$error= $_GET['error'];
							if ($error==3) echo "<script>alert('Check Out Successful');</script>"; 	
